...
<div class="row">
  <div class="col-sm-12 text-center">
    ...
    <h4><a href="<?php echo $pages->get("name=places")->photo->eq(0)->url; ?>" target="_blank" data-toggle="tooltip" title="Write the corresponding number on your places in your copybook.">See the map with numbers</a></h4>
  </div>
  <div class="col-sm-12">
  <?php
